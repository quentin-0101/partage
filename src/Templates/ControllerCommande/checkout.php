...
<body>
                        ...
                        <div class="right-text">
                            <ul class="user-links">
                                <li class="main-li">
                                    ...
                                    <ul class="drop-list">
                                        <li>
                                            <a href="#"> <img src="images/France.jpg" alt="France" /> France </a>
                                        </li>
                                        <li>
                                            <a href="#"> <img src="images/English.jpg" alt="France" /> English </a>
                                        </li>
                                        <li>
                                            <a href="#"> <img src="images/Spain.jpg" alt="France" /> Spain </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="main-li">
                                ...
                                <li class="main-li form-hover">
                                    ...
                                    <div class="hover-content">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="account.html"> <i class="icofont-user"></i> Your Account </a>
                                            </li>
                                            <li>
                                                <a href="orders.html"> <i class="icofont-bag"></i> Your Order </a>
                                            </li>
                                            <li>
                                                <a href="Wishlist.html" class="Wishlist"> <i class="icofont-heart"></i> Your Wishlist </a>
                                            </li>
                                            <li>
                                                <a href="product-review.html"> <i class="icofont-eye-alt"></i> Your Product Reviews </a>
                                            </li>
                                            <li>
                                                <a href="news-subscribe.html"> <i class="icofont-envelope"></i> Newsletter Subscription</a>
                                            </li>
                                            <li>
                                                <a href="billing-agreements.html"> <i class="icofont-checked"></i> Billing Agreements </a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                            ...
                            <div class="search-categ">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <p> <input type="checkbox" id="3" value="Necklaces" onclick="myCatSelect(this)"> Beaded Necklaces</p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="4" value="Pendants" onclick="myCatSelect(this)"> Pendants</p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="5" value="Necklaces" onclick="myCatSelect(this)"> Necklaces</p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="6" value="Charm Necklaces" onclick="myCatSelect(this)"> Charm Necklaces</p>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <p> <input type="checkbox" id="7" value="Hoop Earrings" onclick="myCatSelect(this)"> Hoop Earrings </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="8" value="Stud Earrings" onclick="myCatSelect(this)"> Stud Earrings </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="9" value="Chandelier Earrings" onclick="myCatSelect(this)"> Chandelier Earrings </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="10" value="Cluster Earrings" onclick="myCatSelect(this)"> Cluster Earrings </p>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="11" value="Brooches" onclick="myCatSelect(this)"> Brooches </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="12" value="Bracelets" onclick="myCatSelect(this)"> Bracelets </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="13" value="Rings" onclick="myCatSelect(this)"> Rings </p>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <p> <input type="checkbox" id="13" value="Nike" onclick="myCatSelect(this)"> Nike </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="14" value="Puma" onclick="myCatSelect(this)"> Puma </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="15" value="Adidas" onclick="myCatSelect(this)"> Adidas</p>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <p> <input type="checkbox" id="16" value="Nike" onclick="myCatSelect(this)"> Nike </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="17" value="Puma" onclick="myCatSelect(this)"> Puma </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="18" value="Adidas" onclick="myCatSelect(this)"> Adidas</p>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <p> <input type="checkbox" id="20" value="Nike" onclick="myCatSelect(this)"> Nike </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="21" value="Puma" onclick="myCatSelect(this)"> Puma </p>
                                                    </li>
                                                    <li>
                                                        <p> <input type="checkbox" id="22" value="Adidas" onclick="myCatSelect(this)"> Adidas</p>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <p> <input type="checkbox" id="24" value="Accessories" onclick="myCatSelect(this)"> Accessories </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="25" value="Storage" onclick="myCatSelect(this)"> Storage </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="26" value="Printers" onclick="myCatSelect(this)"> Printers </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="27" value="Components" onclick="myCatSelect(this)"> Network Components </p>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <p> <input type="checkbox" id="29" value="Accessories" onclick="myCatSelect(this)"> Accessories </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="30" value="Storage" onclick="myCatSelect(this)"> Storage </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="31" value="Printers" onclick="myCatSelect(this)"> Printers </p>
                                            </li>
                                            <li>
                                                <p> <input type="checkbox" id="32" value="Components" onclick="myCatSelect(this)"> Network Components </p>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <p> <input type="checkbox" id="33" value="Food" onclick="myCatSelect(this)"> Food </p>
                                    </li>
                                    <li>
                                        <p> <input type="checkbox" id="34" value="Books" onclick="myCatSelect(this)"> Books </p>
                                    </li>
                                    <li>
                                        <p> <input type="checkbox" id="35" value="Fashion" onclick="myCatSelect(this)"> Fashion </p>
                                    </li>
                                    <li>
                                        <p> <input type="checkbox" id="36" value="Infant Toys " onclick="myCatSelect(this)"> Infant Toys </p>
                                    </li>
                                </ul>
                            </div>
                        </form>
                                    ...
                                    <div class="item-box">
                                        ...
                                        <div class="data">
                                            ...
                                            <div class="item-footer">
                                                <p>  Qty :   <input type="text" value="<?php echo $p->getQuantite() ?>"> </p>
                                                <div class="actions">
                                        ...
                                        <div class="col-12">
                                            <div class="brands-slider">
                                                <div class="owl-carousel owl-theme brands-owl">
                                                    <div class="item">
                                                        <a href=""> <img src="images/brand-1.png" class="img-fluid"> </a>
                                                    </div>
                                                    <div class="item">
                                                        <a href=""> <img src="images/brand-2.png" class="img-fluid"> </a>
                                                    </div>
                                                    <div class="item">
                                                        <a href=""> <img src="images/brand-3.png" class="img-fluid"> </a>
                                                    </div>
                                                    <div class="item">
                                                        <a href=""> <img src="images/brand-4.png" class="img-fluid"> </a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <a class="prod-block">
                                                        ...
                                                        <p> Splendido Oro(Tm) 14k Yellow Gold 1mm Clover Link 22 Inch Chain 1.6 GHz Intel Core I5 (Broadwell) 4GB Yellow Gold 1mm Clover Link 22 Inch Chain 1.6 GHz Intel Core I5 (Broadwell) 4GB
                                                        </p>
                                                    </a>
                                                </div>
                                            </div>
    ...
    <div class="internal-page-introduction">
        <img src="images/checkout_banner.png" alt="img" class="img-fluid">
        <div class="text">
            <h2> CHECKOUT </h2>
        </div>
    </div>

    <div class="internal-main-content cart-page checkout-page">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="checkout-shipping-address">
                                ...
                                <div class="box-body">
                                    <?php /** @var UtilisateurLivraison $adresseDefault */
                                     /** @var UtilisateurLivraison $addr */
                                    ...
                                    <?php if(isset($adresseDefault)) : ?>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="address">
                                            <label><?php echo $adresseDefault ?>  </label>
                                        </div>

                                        <?php foreach ($adresses as $addr): ?>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="address">
                                                <label><?php echo $addr ?>  </label>
                                            </div>
                                        <?php endforeach; ?>
                                    <?php endif; ?>

                                    <a data-toggle="modal" data-target="#newaddress" class="btn btn-orange"> <i class="icofont-plus"></i> New Address </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="checkout-shipping-method">
                                <div class="box-title">
                                    <h3> <span> 2  </span> SHIPPING METHOD </h3>
                                </div>
                                <div class="box-body">
                                    <div class="field">
                                        ...
                                        <script>
                                            function changePrice(livraison){
                                                httpGet('?controller=commande&action=checkout&livraison=' + livraison);
                                                console.log("selected");
                                            }
                                        </script>

                                        <?php foreach ($livraisons as $nom => $tabPrixAndDelais) : ?>

                                            <div class="form-check">
                                                <input onclick="changePrice('<?php echo rawurlencode($tabPrixAndDelais[0]) ?>')" class="form-check-input" type="radio" name="service">
                                                <label> <?php echo $nom ?>   $ <?php echo $tabPrixAndDelais[0] ?> : (<?php echo $tabPrixAndDelais[1] ?>) jours ouvrés  </label>
                                            </div>
                                        <?php endforeach; ?>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="checkout-payment-method">
                                ...
                                <div class="box-body">
                                    <div class="form-check">
                                        <input class="form-check-input radio_box" id="credit" type="radio" name="service" onclick="radioChecked(this)">
                                        <label> Credit Card Direct Post (Authorize.net) </label>
                                    </div>
                                    <div class="pay-option-box credit-pay-box">
                                        <div class="form-check">
                                            <input type="checkbox" class="bill_same_address" aria-label="Checkbox" checked onclick="itemChecked(this)">
                                            <label> My billing and shipping address are the same </label>
                                        </div>
                                        <div class="change-address-box">
                                            <form action="">
                                                <select class="form-control">
                                                    <option value="0"> Dakahlia Governorate 35511  </option>
                                                    <option value="2"> 35511 Mansoura, Maine  </option>
                                                </select>
                                        ...
                                        <ul>
                                            <li> Hossam Hilal </li>
                                            <li> mansoura </li>
                                            <li> Mansoura, Dakahlia Governorate 35511 </li>
                                            <li> Egypt </li>
                                            <li> 01099285016 </li>
                                        </ul>
                                        <img src="images/icon-footer.png" alt="visa" class="img-fluid">
                                        <div class="field required-field"> 
                                            <label> Credit Card Number </label>
                                            <input type="text" class="form-control">
                                        </div>
                                        <div class="field required-field visa-date"> 
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input radio_box" type="radio" name="service" onclick="radioChecked(this)">
                                        <label> Cash On Delivery </label>
                                    </div>
                                    <div class="pay-option-box cash-pay-box">
                                        <div class="form-check">
                                            <input type="checkbox" class="bill_same_address" aria-label="Checkbox" checked onclick="itemChecked(this)">
                                            <label> My billing and shipping address are the same </label>
                                        </div>
                        ...
                        <div class="col-12 col-sm-12">
                            <div class="checkout-shipping-address">
                                <div class="box-title">
                                    <h3> <span> 4 </span> ORDER REVIEWS </h3>
                                </div>
                                <div class="box-body">
                                    <form>
                                        ...
                                        <div class="checkout-summary">
                                            <ul>
                                                <li> Subtotal: <span> $ <?php echo Panier::getPrixTotal() ?> </span></li>
                                                <li> Shipping: <span id="fraisPort"> <?php echo $prixLivraison ?>   </span></li>
                                                <li> Discount Codes: <span> -$ 0.00           </span></li>
                                                <li> Gift Wrap: <span>  $0.00               </span></li>
                                                <li> Order Total: <span> $ <?php echo Panier::getPrixTotal() ?> </span></li>
                                            </ul>
                                            <ul>
                                                <li> Discount Codes: <span> </span> </li>
                                            </ul>
                                            <ul>
                                                <li> Comment : </li>
                                                <li>
                                            ...
                                            <div class="total">
                                                <h3> Order Total </h3>
                                                <p> $ <?php echo Panier::getPrixTotal() ?> </p>
                                            </div>
                                        </div>


                                        <button class="btn btn-orange form-btn" type="submit"> Place Order </button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <!-- New Address Modal -->
    <div class="modal fade newaddress" id="newaddress" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 data-dismiss="modal"> <i class="icofont-close-line"></i> </h5>
                    <h3> Netbaseteam Shipping Address </h3>
                </div>
                <?php /** @var Utilisateur $user */ ?>

                <div class="modal-body">
                    <form action="?controller=commande&action=new_address_commande">
                        <div class="field required-field"> 
                            <label> First Name </label>
                            <input name="nom" type="text" class="form-control" value="<?php if(isset($login) && $login) echo $user->getNom() ?>">
                        </div>

                        <div class="field required-field"> 
                            <label> Last Name </label>
                            <input name="prenom" type="text" class="form-control" value="<?php if(isset($login) && $login) echo $user->getPrenom() ?>">
                        </div>

                        <div class="field required-field"> 
                            <label> Phone Number </label>
                            <input name="telephone" type="text" class="form-control" value="<?php if(isset($login) && $login) echo $user->getTelephone() ?>">
                        </div>

                        <div class="field required-field"> 
                            <label> Street Address </label>
                            <input name="adresse_postale" type="text" class="form-control" >
                        </div>
                        ...
                        <div class="field required-field"> 
                            ...
                            <input name="code_postale" type="text" class="form-control">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label">  Save in address book </label>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-orange" data-dismiss="modal"> Cancel </button>
                    <button class="btn btn-orange" type="submit">  Save Address </button>
                </div>
            </div>
        </div>
    </div>
