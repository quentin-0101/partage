            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="cart-header">
                        ...
                        <span class="cart-count"> <?php use App\Models\Lib\Panier;

                            echo $nbProduits ?> </span>
                        <span> ITEM (S) </span>
                    </div>
                        ...
                        <div class="checkout-shipping-address">
                            ...
                            <div class="checkout-summary">
                                <ul>
                                    ...
                                    <li> Shipping: <span id="fraisPort"> $ <?php echo $livraisonPrix ?>   </span></li>
                                    <li> Délais de livraison: <span> <?php echo $delais ?> jours ouvrés   </span></li>
                                    <li> Service de livraison: <span> <?php echo $service ?>   </span></li>
                                    <li> Addrese de livraison: <span> <?php echo $adresse ?>   </span></li>
                                    <li> Order Total: <span> $ <?php echo $prixTotal ?> </span></li>
                                </ul>
                                <ul>
                            ...
                            <a href="?controller=commande&action=commander" class="btn btn-orange form-btn" type="submit">Place Order</a>
