                        ...
                        <div class="checkout-shipping-address">
                            ...
                            <div class="box-body">
                                ...
                                <?php if(isset($adresseDefault)) : ?>
                                    <form method="post" action="?controller=commande&action=checkout">
                                        <div class="form-check">
                                            <input value="<?php echo $adresseDefault->getId() ?>" class="form-check-input" type="radio" name="address">
                                            <label><?php echo $adresseDefault ?>  </label>
                                        </div>

                                        <?php foreach ($adresses as $addr): ?>
                                            <div class="form-check">
                                                <input value="<?php echo $addr->getId() ?>" class="form-check-input" type="radio" name="address">
                                                <label><?php echo $addr ?>  </label>
                                            </div>
                                        <?php endforeach; ?>


                                        <button class='btn btn-orange' type='submit'>  Continuer </button>
                                    </form>
                                <?php endif; ?>

                                <?php if(isset($login) && $login) : ?>
                                    <a href="?controller=utilisateurLivraison&action=account_new_address" class="btn btn-orange"> <i class="icofont-plus"></i> New Address </a>
                                <?php else: ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="?controller=commande&action=checkout">
                    ...
                    <div class="field required-field">
                        <label> Email </label>
                        <input name="email" type="email" class="form-control" value="<?php if(isset($login) && $login) echo $user->getEmail() ?>">
                    </div>
