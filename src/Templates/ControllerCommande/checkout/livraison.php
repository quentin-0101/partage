            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="cart-header">
                        ...
                        <span class="cart-count"> <?php use App\Models\DataObject\produit\Produit;
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="checkout-shipping-method">
                            ...
                            <form method="post" class="box-body" action="?controller=commande&action=checkout2">
                                <div class="field">
                                    ...
                                    <?php $var = 0; ?>
                                        <?php foreach ($livraisons as $nom => $tabPrixAndDelais) : ?>
                                            <div class="form-check">
                                                <input value="<?php echo rawurlencode($var) ?>" class="form-check-input" type="radio" name="service">
