                            ...
                            <li class="main-li form-hover">
                                ...
                                <div class="hover-content">
                                    <ul>
                                        ...
                                        <li> <a href="../user/account.php"> <i class="icofont-user"></i> Your Account	</a> </li>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="block">
                        ...
                        <form method="post" action="?controller=utilisateur&action=connect">
                            <h3> Registered Customers </h3>
                            <p> If you have an account, sign in with your email address. </p>

                            <div class="field">
                                <input content="<?php if(isset($user)) echo $user->getEmail() ?>" name="email" type="email" class="form-control" placeholder="Email" required>
                            </div>

                            <div class="field">
                                <input name="motDePasse" type="password" class="form-control" placeholder="Password" required>
                            </div
                            <div class="login-footer">
                                <a href="?controller=utilisateur&action=forgot_password" class="forget-pass"> Forgot Your Password? </a>
                ...
                <div class="col-12 col-md-6">
                    <div class="block">
                        ...
                        <a href="?controller=utilisateur&action=register" class="btn btn-orange"> Create An Account  </a>
                    </div>
                </div>
            </div>
        </div>
